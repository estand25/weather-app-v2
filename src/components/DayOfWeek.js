    ...
    return (
        <div className="DOW_frame">
            <div className="DOW_title_Section">
                <p className="DOW_title">
                    {title}
                </p>
            </div>
            <div className="DOW_Middle_Section">
                {GetWeatherIcon(weather)}
            </div>
            <div className="DOW_Low_Section">
                <div>
                    <p className="DOW_Subtitle_Hight">
                        {DegreeConvertation(highTemp)}
                    </p>
                </div>
                <div>
                    <p className="DOW_Subtitle_Low">
                        {DegreeConvertation(lowTemp)}
                    </p>
                </div>
            </div>
        </div>
